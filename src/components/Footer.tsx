...
const socialLinks: SocialLink[] = [
  ...
  { href: "https://www.instagram.com/_mhsn.ashrfi_/", icon: FaInstagram },
  {
    href: "https://www.linkedin.com/in/mohsen-ashrafi-b6b422377/",
    icon: FaLinkedinIn,
  },
  { href: "https://github.com/Mohsen-Ashrafi", icon: FaGithub },
];
